...
export const OFERTA_LANCAMENTO = {
  ...
  faq: [
    ...
    { pergunta: 'Está caro ou quero desconto adicional', resposta: 'Podemos avaliar o escopo com você. A mensalidade é mantida e não aplico descontos adicionais; condições diferentes precisam ser analisadas pela equipe.' },
...
export function criarPromocao(db, agora = () => new Date()) {
  ...
  async function status() {
    ...
    return { id: PROMOCAO_ID, limite: 10, confirmados: usados, restantes: Math.max(0, 10 - usados), implantacaoNormalCentavos: 149000, implantacaoPromocionalCentavos: 99000, mensalidadeCentavos: 49700 };
  }
  async function confirmar({ clienteId, numero, referencia, usuario }) {
    ...
    const registro = { clienteId: id, numero, referencia: referencia.trim(), em: agora(), usuario, implantacaoCentavos: 99000, mensalidadeCentavos: 49700 };
