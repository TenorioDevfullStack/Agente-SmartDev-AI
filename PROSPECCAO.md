...
7. Abra a campanha. Em **Oferta e atendimento comercial**, escolha atendimento humano ou **Conversa comercial automática**. Use **Usar oferta de lançamento** para preencher os valores-base de R$ 1.490 de implantação e R$ 497/mês. Para as dez primeiras contratações confirmadas, o sistema oferece implantação por R$ 990 e mensalidade de R$ 297 nos três primeiros meses; no quarto mês volta a R$ 497. Confira escopo, condições e perguntas/respostas; clique em **Salvar oferta e modo**. Campanhas antigas permanecem no modo assistido.
...
11. Na tela **Conversas**, **Devolver ao agente** também retoma corretamente o estado comercial do prospecto. Após um reinício, é possível retomar somente aquela conversa sem reativar os disparos da campanha inteira; o agente responde quando o contato enviar uma nova mensagem elegível.
...
- Pedido concreto de demonstração, proposta personalizada, conversa sobre implantação ou avanço na contratação é encaminhado ao Leandro para atendimento personalizado. Interesse genérico ou pedido para conhecer melhor continua no diálogo automático até haver intenção clara.
...
- Uma retomada individual feita no painel libera somente aquele diálogo, inclusive quando a campanha foi pausada pelo reinício. Pausar a campanha novamente ou reiniciar o servidor remove essas liberações individuais.
...
- Ao encaminhar uma conversa para atendimento humano, o sistema envia uma única notificação ao ADMIN_NUMBER, com empresa, telefone, motivo e link direto para o WhatsApp. O número administrativo deve estar configurado e ser diferente do prospecto. Uma nova retomada libera um novo alerta para um encaminhamento futuro; falhas ficam registradas e podem ser tentadas novamente.
...
Na ficha, **Excluir prospecto e recomeçar** remove o cadastro e o histórico operacional daquele número para permitir um teste novo. A ação exige confirmação, preserva a auditoria e recusa exclusão de contratação confirmada ou mensagem em processamento.
